...
def openai(api_key, user_input):
    ...
    completion = client.chat.completions.create(
        model='gpt-4o-mini',
        messages=[
            {'role': 'system', 'content': '너는 똑똑이야 다 알려줘 ! 알잘딱깔쎈으로 즐겁게, 다만 출력 결과에 #은 포함시키지 말아줘'},
...
def langchain(api_key, user_input):
    ...
    loader = WebBaseLoader(
        web_paths=('https://sports.news.nate.com/view/20240723n00108', 'https://sports.chosun.com/baseball/2024-07-23/202407230100173900024528'),
    )
